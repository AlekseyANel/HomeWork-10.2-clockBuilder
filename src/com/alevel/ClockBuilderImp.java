...
public class ClockBuilderImp  implements ClockBuilder {//отдельный бидер строит уникалные часы-объект

    private Clock clockImp;//объявляем переменную clockImp для объекта класса Clock
    public ClockBuilderImp() {//коструктор для нового объекта clockImp класса Clock
        clockImp = new Clock();
    }
